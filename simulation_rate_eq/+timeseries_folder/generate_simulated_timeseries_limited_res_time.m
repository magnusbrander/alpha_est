function [timeSeriesObs,timeSeriesTrue] = generate_simulated_timeseries_limited_res_time(...
    alpha,Xi,L,maxTime,pixelSize,diffusionConst,salt,initialNickNr)
...
parfor n=1:statsNr
    ...
    [timeSeriesObs,timeSeriesTrue,~] = generate_sim_timeseries_lim_time_res(...
        alpha,constVal);
    
    avgCutCountsObs = avgCutCountsObs + timeSeriesObs;
    avgCutCountsTrue = avgCutCountsTrue + timeSeriesTrue;
