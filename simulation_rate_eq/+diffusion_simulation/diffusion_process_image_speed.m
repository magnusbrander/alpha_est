function [allFragPos,allFragLengths,allDetectedMol,allMoleculesIm,...
    timeInstances] = diffusion_process_image_speed(cutInfo,constVal)
...
import image_generate.add_photons;
import image_generate.gen_gamma_image;
...
uniSegConst = constVal.uniSegConst;
lambdaBg = constVal.lambdaBg;
lambdaSig = constVal.lambdaSig;
gain = constVal.gain;
...
allMoleculesIm = cell(1,length(timeInstances));
...
for i=1:length(cutTimes)
    ...
    while t<tMax
        ...
        if newImage == 1
            ...
            bgImage = gen_bg_image(boxSizeRow,boxSizeCol,lambdaBg,gain);
        ...
        if t >= timeInstances(instCount)
            ...
            if instanceIndex - instCount < 1
                ...
                sigImage = sigImage + add_photons(prevPos,prevTime,timeInstances(instCount),...
                    currFragLengths,timeResolution,boxSizeRow,boxSizeCol,pixelSize,lambdaSig);
                
                % Add the gamma distribution on top of the photon count 
                sigImage = gen_gamma_image(sigImage,gain);
                ...
                allMoleculesIm{instCount} = totImage;
                ...
                for inst=instCount:1:instanceIndex
                    ...
                    % Add last intensity to signal image and segment
                    sigImage = sigImage + add_photons(prevPos,prevTime,timeInstances(inst),...
                        currFragLengths,timeResolution,boxSizeRow,boxSizeCol,pixelSize,lambdaSig);
        ...
        sigImage = sigImage + add_photons(prevPos,prevTime,currentTime,...
            currFragLengths,timeResolution,boxSizeRow,boxSizeCol,pixelSize,lambdaSig);
